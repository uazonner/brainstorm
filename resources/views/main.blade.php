...
<header id="main">
    <div class="container">
        ...
        <nav id="main-menu">
            <ul class="primary">
                <li><a class="active" href="#">Блог <i class="fa fa-angle-down" aria-hidden="true"></i></a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="pull-right">
                <a href="#" class="output-switcher"><i class="fa fa-table" aria-hidden="true"></i></a>
            </div>
            <ul class="secondary">
                <li>
            ...
            <div class="col-lg-8 col-md-8">
                <article class="post">
                    <div class="review-content">
                        <div class="row">
                            <div class="col-lg-4">
                                <img src="http://fakeimg.pl/1000x800/" class="img-post img-responsive" alt="Image">
                            </div>
                            <div class="col-lg-8">
                                <h4 class="post-title"><a href="#" class="transicion">Тестовый заголовок</a></h4>
                    ...
                    <div class="review-info">
                        <div class="row">
                            <div class="col-lg-12">
                                <i class="fa fa-clock-o"></i> 20 января 2017 <i class="fa fa-user"></i> Alex-K
                            </div>
                        </div>
                    </div>
                </article>
                ...
                <aside>
                    <section class="sidebar">
                        <div class="input-group">
                            <input placeholder="Поиск..." class="form-control" type="text">
                    ...
                    <section class="sidebar">
                        <div class="block-wraper">
                            <div class="block-heading">
                                <h4 class="block-title blue">Категории</h4>
                            </div>
                    ...
                    <section class="sidebar">
                        <div class="block-wraper">
                            <div class="block-heading">
                                <h4 class="block-title orange">Архив</h4>
                            </div>
                            <div class="block-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atomus, appellat dedocendi omnes quoddam atomos. Vestra. Corrupti sensum multa dissentiet uberius displicet medeam, efficiatur quaeque saluto sollicitare arbitraretur conectitur chaere, deorum consiliisque arbitrer doctrina nasci. Odia malis, scipio, libido. Iudico graviter seditione hoc. Venustate.</p>
                            </div>
                    ...
                    <section class="sidebar">
                        <div class="block-wraper">
                            <div class="block-heading">
                                <h4 class="block-title blue">Комментарии</h4>
                            </div>
                            <div class="block-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atomus, appellat dedocendi omnes quoddam atomos. Vestra. Corrupti sensum multa dissentiet uberius displicet medeam, efficiatur quaeque saluto sollicitare arbitraretur conectitur chaere, deorum consiliisque arbitrer doctrina nasci. Odia malis, scipio, libido. Iudico graviter seditione hoc. Venustate.</p>
                            </div>
